...
<div class="page">
  ...
  <!-- Footer -->
  <div class="footer">
    <p>This report is computer-generated by ${settings.companyName} — Kynex Pharmacloud Management System. All figures are based on recorded transactions and may be subject to audit verification.</p>
...
<div class="watermark">Kynex Pharmacloud v2.0 — ${settings.companyName}</div>
</body></html>`);
